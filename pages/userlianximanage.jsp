        ...
        <div id="kv2nq1xw">
            ...
            <form id="searchform" qw-c="searchform" style="text-align: left;width:90%;margin-bottom: 30px;"
                ...
                <div class="row">
                    ...
                    <button class="btn btn-primary" type="button" style="float: left;margin-left: 30px;" class="btn btn-info" id="generate-excel">导出excel</button>

                </div>
            </form>
            <table class="table" qw-c="table" id="example23" style="margin-top: 80px;">
                <thead>
                <tr>
                    <td>名字
                    ...
                    <c:forEach items="${ lianxiall}" var="item">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!--  定义修改联系人按钮和删除联系人按钮，修改提交地址为userupdatelianxi.action?id=${item.id}，删除提交地址为 userdeletelianxi.action?id=${item.id}-->

                                <a href="userupdatelianxi.action?id=${item.id}">修改</a> <a
                                    href="userdeletelianxi.action?id=${item.id}">删除</a>
            ...
            <div style="margin-top: 15px;">
                ...
                <script type="text/javascript" src="resource/external/jszip.min.js"></script>
                <script type="text/javascript" src="resource/external/FileSaver.js"></script>
                <script type="text/javascript" src="resource/external/excel-gen.js"></script>
                <script>
