...
<div id="kv2jg8jy">
    ...
    <div id="kv2no1ui">
        <div id="kv2nq1xw">
            <form method="post" qw-c="operationform" action="useraddlianxiact.action" enctype="multipart/form-data" onsubmit="return tableToJson()">
                ...
                <div class="form-group" qw-c="forminputcomponent" style="display: none">
                    <label qw-c="forminputtext">重要</label>
                    <div class="controls">
                        <!-- 定义zhongyao输入框 -->

                        <input name="zhongyao" value="普通" class="form-control" qw-c="forminput">
                    </div>
                </div>
                <div style='display:none;' class="form-group" qw-c="forminputcomponent">
                    ...
                    <div style='display:none;' class="controls">
                        <!-- 使用el表达式给user复制，将session中的user赋值到input中-->
                ...
                <div style='display:none;' class="form-group" qw-c="forminputcomponent">
                    ...
                    <div style='display:none;' class="controls">
                        <!-- 使用el表达式给userid复制，将session中的userid赋值到input中-->
