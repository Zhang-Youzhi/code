...
<div id="kv2jg8jy">
    ...
    <div id="kv2no1ui">
        <div id="kv2nq1xw">
            <form method="post" qw-c="operationform" action="adduseract.action" enctype="multipart/form-data">
                ...
                <div class="form-group" qw-c="forminputcomponent">
                    ...
                    <div class="controls">
                        ...
                        <input name="sex" class="form-control" qw-c="forminput">
                    </div>
                </div>
                <div class="form-group" qw-c="forminputcomponent">
                    ...
                    <div class="controls">
                        ...
                        <input name="age" class="form-control" qw-c="forminput">
                    </div>
                </div>
